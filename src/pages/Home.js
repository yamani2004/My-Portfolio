    ...
    <section className="home-section">
      ...
      <div className="home-container">
        ...
        <div className="intro-card">
          ...
          <h2 className="intro-subtitle">Frontend Developer & Web Enthusiast</h2>

          <p className="intro-text">
            I design and build clean, responsive, and efficient web experiences.
            With a strong foundation in modern front-end development and problem-solving,
            I enjoy transforming ideas into real, user-friendly digital interfaces.
          </p>
